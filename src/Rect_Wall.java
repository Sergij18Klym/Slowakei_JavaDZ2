...
public class Rect_Wall extends Rectangle{
    ...
    public Rect_Wall(int id, double length, double width, String color, String material, boolean isPlaster, int pricePlasterPerMeter, int priceForColoringForMeter, boolean isBase, int windowsAmount) {
